...
public interface SupervisorStorageService {
    ...
    public void insertSupervisor( String sussexId, String password, String name, String surname, String emailAddress, String department, String telephoneNumber, Collection<Project> projects);
}
